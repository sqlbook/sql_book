...
%o`, message, error2, detail);
  ...
  var clipboard_controller_default = class extends Controller {
    ...
    copy() {
      ...
      setTimeout(() => this.buttonTarget.innerText = originalText, 1e3);
    }
  };

  // app/javascript/controllers/data_source_query_controller.js
  var data_source_query_controller_default = class extends Controller {
  ...
  // app/javascript/controllers/data_source_select_controller.js
  var data_source_select_controller_default = class extends Controller {
    change() {
      this.element.requestSubmit();
    }
  };

  // app/javascript/controllers/data_source_verification_controller.js
  var data_source_verification_controller_default = class extends Controller {
    connect() {
  ...
  application.register("data-source-query", data_source_query_controller_default);
  application.register("data-source-select", data_source_select_controller_default);
  application.register("data-source-verification", data_source_verification_controller_default);
